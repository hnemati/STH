...
 void mem_mmu_tlb_invalidate_one(BOOL inst, BOOL data,
...
static void mem_icache_invalidate(BOOL clean_it) 
{
	    ...
	    COP_READ2(COP_SYSTEM, "1", COP_ID_CACHE_CONTROL_ARMv7_CLIDR,
		      clidr);
...
 void mem_cache_invalidate(BOOL inst_inv, BOOL data_inv,
			     BOOL data_writeback) 
{
