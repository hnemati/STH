		    ...
		    icmProcessorP * cpu_, icmBusP * bus_)
{
	...
	icmPseP ethlan_p =
	    icmNewPSE("ethlan", ethlan_path, ethlan_attr, 0, 0);
	icmConnectPSEBus(ethlan_p, bus1_b, "bport1", 0, 0xc8000000,
			 0xc8000fff);
	...
	/* PSE rtc */
	const char *rtc_path =
	    icmGetVlnvString(0, 0, 0, "RtcPL031", 0, "pse");
	...
	icmConnectPSEBus(uart1_p, bus1_b, "bport1", 0, 0x16000000,
			 0x16000fff);
	...
	icmConnectPSEBus(uart2_p, bus1_b, "bport1", 0, 0x17000000,
			 0x17000fff);
	...
	/* PSE lcd */
	const char *lcd_path =
	    icmGetVlnvString(0, 0, 0, "LcdPL110", 0, "pse");
	const char *lcd_pe =
	    icmGetVlnvString(0, 0, 0, "LcdPL110", 0, "model");
